 ...
 * Text Domain: mpesa-payment-gateway
...
final class Plugin
{
    ...
    public function checkVersionRequirements(): void
    {
            ...
            add_action('admin_notices', function () {
                printf(
                    ...
                    sprintf(
                        ...
                        esc_html__('M-Pesa Payment Gateway requires PHP version %1$s or higher. You are running version %2$s.', 'mpesa-payment-gateway'),
            ...
            add_action('admin_notices', function () use ($wp_version) {
                printf(
                    ...
                    sprintf(
                        ...
                        esc_html__('M-Pesa Payment Gateway requires WordPress version %1$s or higher. You are running version %2$s.', 'mpesa-payment-gateway'),
        ...
        if (!$this->isWooCommerceActive()) {
            add_action('admin_notices', function () {
                printf(
                    '<div class="notice notice-error"><p>%s</p></div>',
                    esc_html__('M-Pesa Payment Gateway requires WooCommerce to be installed and activated.', 'mpesa-payment-gateway')
                );
            });
            return;
        }
            ...
            add_action('admin_notices', function () {
                printf(
                    ...
                    sprintf(
                        ...
                        esc_html__('M-Pesa Payment Gateway requires WooCommerce version %1$s or higher. You are running version %2$s.', 'mpesa-payment-gateway'),
    ...
    public function activate(): void
    {
        if (!$this->isWooCommerceActive()) {
            ...
            wp_die(
                esc_html__('Please install and activate WooCommerce before activating M-Pesa Payment Gateway.', 'mpesa-payment-gateway'),
                esc_html__('Plugin Activation Error', 'mpesa-payment-gateway'),
                ['back_link' => true]
            );
        }
