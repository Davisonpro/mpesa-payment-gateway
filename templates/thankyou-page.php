...
<div class="woo-mpesa-thank-you">
    ...
    <?php if ($woo_mpesa_phone): ?>
        <p><strong><?php esc_html_e('Phone Number:', 'mpesa-payment-gateway'); ?></strong> <?php echo esc_html($woo_mpesa_phone); ?></p>
    <?php endif; ?>
    
    <?php if ($woo_mpesa_merchant_request_id): ?>
        <p><strong><?php esc_html_e('Request ID:', 'mpesa-payment-gateway'); ?></strong> <code><?php echo esc_html($woo_mpesa_merchant_request_id); ?></code></p>
    <?php endif; ?>
    
    <p><?php esc_html_e('Once you complete the payment, this page will update automatically. If you did not receive the prompt, please wait a moment and refresh this page.', 'mpesa-payment-gateway'); ?></p>
</div>
